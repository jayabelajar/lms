    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">
                {{ __('Admin Mata Kuliah') }}
            </h2>
            <x-button href="{{ route('admin.courses.create') }}" icon="plus" class="w-full sm:w-auto">
        ...
        <div class="overflow-x-auto w-full">
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-900/40">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                                    <x-button href="{{ route('admin.courses.show', $course) }}" size="sm" variant="secondary" icon="eye">
                                        Lihat
                                    </x-button>
                                    <x-button href="{{ route('admin.courses.edit', $course) }}" size="sm" variant="secondary" icon="edit">
                                        Ubah
                                    </x-button>
                                    <form action="{{ route('admin.courses.destroy', $course) }}" method="POST">
                                        ...
                                        <x-button type="submit" size="sm" variant="danger" icon="trash"
                                            onclick="return confirm('Hapus course?')">
                                            Hapus
                                        </x-button>
                                    </form>
                                </div>
                    ...
                    @empty
                        <tr>
                            <td class="px-4 py-6 text-center text-gray-500" colspan="4">Belum ada mata kuliah.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
