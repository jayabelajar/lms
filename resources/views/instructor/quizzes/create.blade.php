    ...
    <x-card>
        <x-slot name="header">
            <div>
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Buat kuis</h3>
            </div>
        </x-slot>
        ...
        <form method="POST" action="{{ route('instructor.quizzes.store') }}" class="space-y-6">
            ...
            <x-input label="Judul" name="title" type="text" icon="list" required />
            <x-textarea label="Deskripsi" name="description" icon="notes" rows="4"></x-textarea>
